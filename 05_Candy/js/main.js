...
function run() {
    ...
    var candy_name = candy_categories_names[candy_selector];
    var all_selected = categories_names[candy_selector];
    var all_amount_selected = categories_amount[candy_selector  ];
